                                                            ...
                                                            @if($orders && isset($orders->items))
                                                                @foreach(json_decode($orders->items) as $item)
                                                                    @if($item->title == $product->product_name)
                                                                        ...
                                                                        <tr>
                                                                            <td>{{ $product->id }}</td>
                                                                            <td><img class="product-img" src="{{ asset('images/products/' . json_decode($product->image_data)[0]) }}" alt=""></td>
                                                                            <td><strong>{{ $product->product_name }}</strong><br>{{ $product->full_detail }}</td>
                                                                            <td class="text-center">{{ $product->quantity }}</td>
                                                                            <td class="text-center">{{ $product->price }} DZD</td>
