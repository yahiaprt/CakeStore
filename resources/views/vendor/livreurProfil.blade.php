...
<div class="ec-content-wrapper">
			...
			<div class="form-check form-check-inline">
                ...
                <label>les deux</label>
																...
																<div class="media py-3 align-items-center justify-content-between">
																	...
																	<div class="media-body pr-3">
																		<a class="mt-0 mb-1 font-size-15 text-dark" href="#">Delevering Company NAme</a><br>
    ...
    <span class="font-size-12 d-inline-block"><i class="mdi mdi-clock-outline"></i> 10 AM</span>
																...
																<div class="media py-3 align-items-center justify-content-between">
																	...
																	<div class="media-body pr-3">
																		<a class="mt-0 mb-1 font-size-15 text-dark" href="#">start-work  Time</a> <br>
																		<input type='time' Name='closing_time' value='{{ $seller -> closing_time }}'>	
																	</div>
																	<div class="media-body pr-3">
																		<a class="mt-0 mb-1 font-size-15 text-dark" href="#">end-work Time</a> <br>
